...
<body>
	<form name="updateProfessorProfileForm" method="post" action="updateProfessorProfile.do">	
		Welcome, ${username} !      <a href="/professor.do">Home</a>      <a href="/login.do">Logout</a>	
		<p>${errorMessage}
		<div class="container">				
			...
			<table>		
				...
				<td><input type="text" value="${user.department}" name="department"></td>
				</tr>
				<tr></tr>				
				<tr></tr>
			</table>
