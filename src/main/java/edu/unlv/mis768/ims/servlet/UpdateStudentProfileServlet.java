...
@WebServlet(urlPatterns ="/updateStudentProfile.do")
...
public class UpdateStudentProfileServlet extends HttpServlet{	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		request.getRequestDispatcher("/WEB-INF/updateStudentProfile.jsp").forward(request, response);	
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{		
		...
		//get parameter value from student profile page
