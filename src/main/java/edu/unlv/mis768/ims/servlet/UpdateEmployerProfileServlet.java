...
@WebServlet(urlPatterns ="/updateEmployerProfile.do")
...
public class UpdateEmployerProfileServlet extends HttpServlet{		
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		request.getRequestDispatcher("/WEB-INF/updateEmployerProfile.jsp").forward(request, response);	
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{		
		...
		//get parameter value from employer profile page
