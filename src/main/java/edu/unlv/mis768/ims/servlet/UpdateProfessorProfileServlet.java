...
@WebServlet(urlPatterns ="/updateProfessorProfile.do")

public class UpdateProfessorProfileServlet extends HttpServlet{	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		request.getRequestDispatcher("/WEB-INF/updateProfessorProfile.jsp").forward(request, response);	
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{		
		...
		//get parameter value from professor profile page
